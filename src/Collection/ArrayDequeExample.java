...
public class ArrayDequeExample {
	public static void main(String[] args) {
		...
		// element tuong tu getFirst va peek() peekFirst()( not throw Exception), element() and 
		// peek() la tu Queue thực hiện ở 1 đầu, còn getFirst() và peekFirst() là của DeQueue thực hiện ở hai đầu.
